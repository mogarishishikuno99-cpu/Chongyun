...
module.exports = {
    ...
    langs: {
        en: {
            ...
            loadedSuccess: "✅ | (%1) commande(s) chargée(s) avec succès",
            loadedFail: "❌ | Échec du chargement de (%1) commande(s)\n%2",
            ...
            missingUrlCodeOrFileName: "⚠️ | Veuillez entrer l'URL ou le code ainsi que le nom du fichier de la commande à installer",
            missingUrlOrCode: "⚠️ | Veuillez entrer l'URL ou le code du fichier de commande à installer",
            ...
            alreadExist: "⚠️ | Le fichier de commande existe déjà, êtes-vous sûr de vouloir écraser l'ancien fichier ?\nRéagissez à ce message avec n'importe quelle émotion pour continuer",
            installed: "✅ | Commande \"%1\" installée avec succès, le fichier est enregistré à l'emplacement %2",
